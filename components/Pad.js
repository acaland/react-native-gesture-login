        ...
        return (
            <View style={{width: width, height: height}}>
                ...
                <View style={style.row}>
                    <Dot lined={points.A} circleStyle={[style.circle, circleStyle]}
                         centerStyle={[style.center, centerStyle]}
                         linedCircleStyle={linedCircleStyle} linedCenterStyle={linedCenterStyle}/>
                    <Dot lined={points.B} circleStyle={[style.circle, circleStyle]}
                         centerStyle={[style.center, centerStyle]}
                         linedCircleStyle={linedCircleStyle} linedCenterStyle={linedCenterStyle}/>
                    <Dot lined={points.C} circleStyle={[style.circle, circleStyle]}
                         centerStyle={[style.center, centerStyle]}
                         linedCircleStyle={linedCircleStyle} linedCenterStyle={linedCenterStyle}/>
                </View>

                <View style={style.row}>
                    <Dot lined={points.D} circleStyle={[style.circle, circleStyle]}
                         centerStyle={[style.center, centerStyle]}
                         linedCircleStyle={linedCircleStyle} linedCenterStyle={linedCenterStyle}/>
                    <Dot lined={points.E} circleStyle={[style.circle, circleStyle]}
                         centerStyle={[style.center, centerStyle]}
                         linedCircleStyle={linedCircleStyle} linedCenterStyle={linedCenterStyle}/>
                    <Dot lined={points.F} circleStyle={[style.circle, circleStyle]}
                         centerStyle={[style.center, centerStyle]}
                         linedCircleStyle={linedCircleStyle} linedCenterStyle={linedCenterStyle}/>
                </View>

                <View style={style.row}>
                    <Dot lined={points.G} circleStyle={[style.circle, circleStyle]}
                         centerStyle={[style.center, centerStyle]}
                         linedCircleStyle={linedCircleStyle} linedCenterStyle={linedCenterStyle}/>
                    <Dot lined={points.H} circleStyle={[style.circle, circleStyle]}
                         centerStyle={[style.center, centerStyle]}
                         linedCircleStyle={linedCircleStyle} linedCenterStyle={linedCenterStyle}/>
                    <Dot lined={points.I} circleStyle={[style.circle, circleStyle]}
                         centerStyle={[style.center, centerStyle]}
                         linedCircleStyle={linedCircleStyle} linedCenterStyle={linedCenterStyle}/>
                </View>
